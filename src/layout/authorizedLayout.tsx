...
export default function AuthorizedLayout({
  ...
  return (
    <>
      <div className="shadow-2xs dark:bg-black dark:border-b-[1px] dark:border-b-white w-full h-16  flex items-center justify-between pr-4 sm:px-10">
        <div>
          <Image
            src={Logo}
            alt="Main-Logo"
        ...
        <div className="flex items-center justify-center space-x-4 sm:gap-4 gap-10 text-sm">
          ...
          <div className="  relative inline-block" ref={dropdownRef}>
            <FaRegCircleUser className="size-6 dark:text-blue-400 cursor-pointer"  onClick={()=>setOpen(!open)} />
            {open && (
              <div className="absolute w-28  left-1/12 border-b-1  mt-2 -translate-x-1/2 bg-gray-100 p-2 rounded-[10px] ">
                ...
                <p className="py-1 cursor-pointer" onClick={()=>handleLogoutClick()}>Logout</p>
              </div>
            )}
          </div>
        </div>
